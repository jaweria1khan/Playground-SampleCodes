...
//        var aLocalVariable = "Local variable"
        //print("\(aLocalVariable) printed from methodB in BClass")
       
        //Step 4. Try to print aPrivateProperty Here
//        print("\(aPrivateProperty) printed from methodA in BClass")
    }
...
//        print("\(aFilePrivateProperty) printed in AnotherClassInTheSameFile")
